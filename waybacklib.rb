...
require 'cgi'
require 'json'
require_relative 'wayback_machine_downloader/tidy_bytes.rb'
require_relative 'wayback_machine_downloader/to_regex.rb'
require_relative 'wayback_machine_downloader/archive_api.rb'
